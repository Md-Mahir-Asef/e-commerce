            ...
            try {
                ...
                if (productData) {
                    ...
                    setSelectedCategories(
                        new Set(productData.categories.map((c: any) => c.name)),
                    );
                    ...
                    {images.length > 0 && (
                        <div className="space-y-2">
                            <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">
                                Product Images ({images.length}) - Drag to
                                reorder
                            </h3>
                            <div className="grid grid-cols-2 gap-2 max-h-64 overflow-y-auto">
                                {images.map((imageName, index) => (
                                    <div
                                        key={imageName}
                                        className="relative group border border-gray-200 dark:border-gray-600 rounded-md overflow-hidden cursor-move"
                                        draggable
                                        onDragStart={() =>
                                    ...
                                    >
                                        <div className="absolute top-1 left-1 bg-gray-800 bg-opacity-70 text-white rounded p-1 opacity-0 group-hover:opacity-100 transition-opacity z-10">
